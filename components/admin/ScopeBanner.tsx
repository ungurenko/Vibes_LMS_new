...
const ScopeBanner: React.FC<ScopeBannerProps> = ({ cohortName, type, label }) => {
  if (type === 'filtered' && cohortName) {
    return (
      <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-violet-50 dark:bg-violet-500/10 border border-violet-200 dark:border-violet-500/20 mb-6">
        <Filter size={14} className="text-violet-500 dark:text-violet-400 shrink-0" />
