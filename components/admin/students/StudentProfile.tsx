                      ...
                      <div className="space-y-6">
                          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200 dark:border-white/5">
                              ...
                              <div className="space-y-4">
                                  <div className="flex items-center justify-between p-4 rounded-2xl bg-violet-50 dark:bg-violet-500/10">
                                      <div className="flex items-center gap-3">
                                          <div className="p-2 bg-white dark:bg-white/10 rounded-lg text-violet-600">
                                              <CheckCircle size={20} />
                                          </div>
                      ...
                      <div className="lg:col-span-2 space-y-6">
                               ...
                               <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                                   ...
                                   <div>
                                       ...
                                       {student.projects.github ? (
                                           <a href={student.projects.github} target="_blank" rel="noopener" className="flex items-center gap-2 text-violet-600 hover:underline font-medium">
                                               <Github size={16} />
                           ...
                           <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-white/5">
                               <div className="flex items-center justify-between mb-6">
                                   ...
                                   <button onClick={() => setActiveTab('activity')} className="text-sm text-violet-600 font-bold hover:underline">Смотреть все</button>
                               </div>
                                      ...
                                      {module.lessons.map((lesson, lIndex) => (
                                          ...
                                          >
                                              <div className={`mt-0.5 ${
                                                  ...
                                                  lesson.status === 'locked' ? 'text-zinc-300' : 'text-violet-500'
                                              }`}>
                ...
                {activity.map((item) => (
                    <div key={item.id} className="relative flex gap-6">
                        <div className={`relative z-10 w-10 h-10 rounded-full border-4 border-white dark:border-zinc-900 flex items-center justify-center shrink-0 ${
                           ...
                           item.iconType === 'chat' ? 'bg-violet-100 text-violet-600' : 
                        ...
                        <div className="pt-2">
                             ...
                             {item.target && (
                                 <div className="text-sm text-violet-600 dark:text-violet-400 font-medium bg-violet-50 dark:bg-violet-500/10 px-3 py-1.5 rounded-lg w-fit">
                                     {item.target}
                                 </div>
                             )}
                        </div>
