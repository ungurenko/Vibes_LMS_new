...
const Onboarding: React.FC<OnboardingProps> = ({ userName, onComplete }) => {
  ...
  const Screen1 = () => (
    <div className="text-center max-w-lg mx-auto">
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        className="w-20 h-20 sm:w-24 sm:h-24 bg-violet-100 dark:bg-violet-900/30 rounded-full flex items-center justify-center mx-auto mb-6 sm:mb-8 text-3xl sm:text-4xl"
      >
        👋
      </motion.div>
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-zinc-900 dark:text-white mb-4 sm:mb-6">
        Привет, {userName}!
      </h2>
      <p className="text-lg sm:text-xl text-zinc-500 dark:text-zinc-400 mb-6 sm:mb-10 leading-relaxed">
        У тебя всё получится. Мы здесь не чтобы кодить сутками, а чтобы создавать крутые вещи в кайф.
      </p>
      <button onClick={nextStep} className="px-6 sm:px-8 py-3 sm:py-4 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-2xl font-bold text-base sm:text-lg hover:scale-105 transition-transform flex items-center gap-3 mx-auto">
        <span>Погнали!</span>
        <ArrowRight size={20} />
      </button>
    </div>
  ...
  const Screen2 = () => (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-zinc-900 dark:text-white mb-4 sm:mb-8 text-center">
        Твой путь к результату
      </h2>
      <p className="text-center text-zinc-500 mb-4 sm:mb-8 text-sm sm:text-base">Два готовых продукта за 4 недели.</p>
      <div className="space-y-4 sm:space-y-6 relative before:absolute before:left-[19px] before:top-4 before:bottom-4 before:w-0.5 before:bg-zinc-200 dark:before:bg-zinc-800">
        {[
          ...
          >
            ...
            <div className="bg-white dark:bg-zinc-900 p-4 sm:p-5 rounded-2xl border border-zinc-200 dark:border-white/5 flex-1 shadow-sm">
              <h3 className="font-bold text-base sm:text-lg text-zinc-900 dark:text-white mb-1">{item.title}</h3>
              <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm">{item.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
      <div className="mt-6 sm:mt-10 text-center">
        <button onClick={nextStep} className="px-6 sm:px-8 py-3 sm:py-4 bg-violet-600 text-white rounded-2xl font-bold text-base sm:text-lg hover:bg-violet-500 transition-colors">
          Понятно
        </button>
      </div>
    </div>
  ...
  const Screen3 = () => (
    <div className="max-w-5xl mx-auto text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-zinc-900 dark:text-white mb-6 sm:mb-10">
        Всё необходимое в одном месте
      </h2>
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-10">
        {[
            ...
            <motion.div
                ...
                className="bg-white dark:bg-zinc-900 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-zinc-200 dark:border-white/5 text-left"
            >
                <div className={`w-10 h-10 sm:w-12 sm:h-12 ${card.bg} rounded-xl sm:rounded-2xl flex items-center justify-center ${card.color} mb-3 sm:mb-4`}>
                    <card.icon size={20} className="sm:hidden" />
                    <card.icon size={24} className="hidden sm:block" />
                </div>
                <h3 className="font-bold text-sm sm:text-lg mb-1">{card.title}</h3>
                <p className="text-xs sm:text-sm text-zinc-500">{card.text}</p>
            </motion.div>
        ))}
      </div>
      <button onClick={nextStep} className="px-6 sm:px-8 py-3 sm:py-4 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-2xl font-bold text-base sm:text-lg hover:opacity-90 transition-opacity">
        Супер, идем дальше
      </button>
    </div>
  );
  ...
  const Screen4 = () => (
    <div className="max-w-5xl mx-auto text-center">
      ...
      <p className="text-sm sm:text-base text-zinc-500 dark:text-zinc-400 mb-4 sm:mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-10">
        {STYLES_DATA.slice(0, 4).map((style) => (
          <div
            ...
            className={`cursor-pointer group relative rounded-xl sm:rounded-2xl overflow-hidden aspect-[4/5] sm:aspect-[3/4] transition-all duration-300 ${
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-3 sm:p-4">
              <span className="text-white font-bold text-xs sm:text-sm">{style.name}</span>
            </div>
            {selectedStyle === style.id && (
              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-violet-500 text-white rounded-full p-1">
      ...
      <button
        ...
        className="px-6 sm:px-8 py-3 sm:py-4 bg-violet-600 text-white rounded-2xl font-bold text-base sm:text-lg hover:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
      >
        Выбрал
      </button>
    </div>
  ...
  const Screen5 = () => (
    <div className="text-center max-w-lg mx-auto">
      <div className="relative w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-6 sm:mb-8">
         ...
         />
         <div className="absolute bottom-0 right-0 bg-white dark:bg-zinc-900 p-1.5 sm:p-2 rounded-full shadow-md">
            <Heart size={16} className="sm:hidden text-red-500 fill-current" />
            <Heart size={20} className="hidden sm:block text-red-500 fill-current" />
         </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-zinc-200 dark:border-white/5 mb-6 sm:mb-8 text-left relative">
         ...
         <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-300 leading-relaxed italic">
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 dark:bg-zinc-950 overflow-y-auto overscroll-contain">
      {/* Background blobs */}
      ...
      <div className="min-h-full flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12 pb-[calc(5rem+env(safe-area-inset-bottom))]">
        <motion.div
