                            ...
                            >
                                <div className="flex items-start gap-4 md:gap-6 relative z-10">
                                    ...
                                    <div className="flex-1">
                                        <h3 className={`font-bold text-lg mb-1 transition-colors ${isCompleted ? 'text-zinc-500 dark:text-zinc-400 line-through decoration-2 decoration-violet-300 dark:decoration-violet-700' : 'text-zinc-900 dark:text-white'
                                            }`}>
                                            {step.title}
                                        </h3>
