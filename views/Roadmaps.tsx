        ...
        return (
            ...
            >
                <Button
                    ...
                    className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white mb-6"
                >
                    <ArrowLeft size={18} />
                    Назад к картам
                </Button>
                ...
                <Card className="bg-white dark:bg-zinc-900 rounded-3xl p-6 md:p-8 py-6 md:py-8 border border-zinc-200 dark:border-white/5 shadow-xl shadow-zinc-200/50 dark:shadow-none mb-8 relative overflow-hidden gap-0">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-start justify-between gap-4 mb-4">
                            ...
                            <Badge variant="outline" className="rounded-full bg-zinc-100 dark:bg-white/5 text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 border-zinc-200 dark:border-white/10">
                                {activeMap.category}
                            </Badge>
                        </div>

                        <CardTitle className="font-display text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-3">
                            {activeMap.title}
                        </CardTitle>
                        ...
                        <div className="flex items-center gap-6 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                            ...
                            <div className="flex items-center gap-2">
                                <span className={`w-2 h-2 rounded-full ${activeMap.difficulty === 'Легко' ? 'bg-emerald-500' :
                            ...
                            >
                                <div className="flex items-start gap-4 md:gap-6 relative z-10">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className={`text-sm leading-relaxed ${isCompleted ? 'text-zinc-400 dark:text-zinc-600' : 'text-zinc-500 dark:text-zinc-400'
                                            }`}>
                                            {step.description}
                                        </p>
