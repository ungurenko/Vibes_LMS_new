...
const UserProfile: React.FC<UserProfileProps> = ({ user, onUserUpdate }) => {
  ...
  return (
    <div className="max-w-[800px] mx-auto px-4 md:px-8 py-12 pb-32">
      ...
      <Card className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-white/5 overflow-hidden shadow-sm p-0 py-0 gap-0">

          {/* Avatar Section */}
          <div className="p-8 border-b border-zinc-100 dark:border-white/5 flex flex-col md:flex-row items-center gap-8">
              <div className="relative group shrink-0">
                  <Avatar className="w-32 h-32 border-4 border-zinc-100 dark:border-zinc-800 shadow-xl">
