                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    {(stageConfig || taskConfig) && (
                                        <div className="flex gap-1.5 mb-3">
                                            {stageConfig && (
                                                <Badge
                                                    variant="outline"
                                                    className={`text-[10px] font-bold cursor-pointer hover:opacity-80 ${stageConfig.color}`}
                                            ...
                                            {taskConfig && (
                                                <Badge
                                                    variant="outline"
                                                    className={`text-[10px] font-bold cursor-pointer hover:opacity-80 ${taskConfig.color}`}
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex gap-2 flex-wrap">
                                            <Badge variant="outline" className={`text-xs font-bold uppercase tracking-wider rounded-lg ${colorClass}`}>
                                                {prompt.category}
                                            </Badge>
                                            {isStack && (
                                    ...
                                    <div className="mt-auto flex flex-wrap gap-2">
                                        {prompt.tags.slice(0, 3).map(tag => (
                                            <Badge key={tag} variant="secondary" className="text-xs text-zinc-400 font-medium bg-zinc-50 dark:bg-white/5 rounded-md">
                                                #{tag}
                                            </Badge>
                                        ))}
                                    </div>
                                    ...
                                    <div className="flex justify-between items-start gap-4">
                                        <div>
                                            <div className="flex items-center gap-3 mb-3">
                                                <Badge variant="outline" className={`rounded-lg text-xs font-bold uppercase tracking-wider ${CATEGORY_COLORS[selectedPrompt.category]}`}>
                                        ...
                                        <Button
                                            ...
                                            size="icon"
                                            onClick={() => setSelectedPrompt(null)}
                                            className="rounded-full bg-zinc-100 dark:bg-white/10 text-zinc-500 hover:text-zinc-900 dark:hover:text-white min-w-[44px] min-h-[44px]"
                                        >
                                            <X size={20} />
                                        </Button>
                                    </div>
                                ...
                                <div className="p-6 border-b border-zinc-100 dark:border-white/5 bg-gradient-to-r from-purple-500/10 to-violet-500/10">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <Button
                                            ...
                                            size="icon"
                                            onClick={handleWizardClose}
                                            className="rounded-full bg-zinc-100 dark:bg-white/10 text-zinc-500 hover:text-zinc-900 dark:hover:text-white"
                                        >
                                            <X size={20} />
                                        </Button>
                                    </div>
