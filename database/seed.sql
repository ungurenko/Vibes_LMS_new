...
BEGIN
    INSERT INTO dashboard_stages (id, title, subtitle, description, week_label, is_active, sort_order, created_at)
    VALUES (stage1_id, 'Основы Веб-дизайна', 'Неделя 1', 'Разбираем HTTP, DNS и как браузер отрисовывает страницы. Фундамент вайб-кодинга.', 'WEEK 01 // BASICS', TRUE, 1, NOW());
...
BEGIN
    INSERT INTO dashboard_stages (id, title, subtitle, description, week_label, is_active, sort_order, created_at)
    VALUES (stage2_id, 'Первый проект', 'Неделя 2', 'Создай своё первое приложение с нуля используя AI. От идеи до деплоя.', 'WEEK 02 // PROJECT', FALSE, 2, NOW());
...
BEGIN
    INSERT INTO dashboard_stages (id, title, subtitle, description, week_label, is_active, sort_order, created_at)
    VALUES (stage3_id, 'Стилизация', 'Недели 3-4', 'Примени дизайн из библиотеки стилей. Сделай проект красивым.', 'WEEK 03-04 // STYLE', FALSE, 3, NOW());
